        ...
        <div className="price">
            <div className="left1">
                <div className="member">
                    <h3><b>Member Exclusive Prices</b></h3>
                    <p>Shop Now</p>
                </div>
